<?php  
$m = new Mongo('mongodb://admin:admin@10.10.30.250:27017');      //这里采用默认连接本机的27017端口，当然你也可以连接远程主机如                   192.168.0.4:27017,如果端口是27017，端口可以省略  
// $db = $m -> admin;
// $result = $db->authenticate('admin','admin');
// var_dump($result);  
