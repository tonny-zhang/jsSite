...
// ========================= Masonry ===============================
  ...
  $.Mason.prototype = {
    ...
    _reLayout : function( callback ) {	      
	  // reset columns		  
	  if(this.options.colOffsetY)
		  this.colYs = this.options.colOffsetY;
	  else{
		  var i = this.cols;
		  this.colYs = [];
		  while (i--) {       
	...
	getProperty: function(name, handler) {
		var prop = this[name] || null;
		if(handler !== undefined && $.isFunction(handler)){
			handler.call(null, prop);
		}
	}
